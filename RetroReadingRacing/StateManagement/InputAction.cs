...
namespace RetroReadingRacing.StateManagement
{
    ...
    public class InputAction
    {
        ...
        public InputAction(Buttons[] triggerButtons, bool firstPressOnly)
        {
        ...
        public InputAction(Keys[] triggerKey)
        {
            _keys = triggerKey != null ? triggerKey.Clone() as Keys[] : new Keys[0];
            _onRelease = true;
        }
