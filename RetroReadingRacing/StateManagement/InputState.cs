...
namespace RetroReadingRacing.StateManagement
{
    ...
    public class InputState
    {
        ...
        public bool IsKeyReleased(Keys key, PlayerIndex? controllingPlayer, out PlayerIndex playerIndex)
        {
            if (controllingPlayer.HasValue)
            {
                // Read input from the specified player.
                ...
                return CurrentKeyboardStates[i].IsKeyUp(key) && _lastKeyboardStates[i].IsKeyDown(key);
            }
            ...
            {
                int i = (int)index;
                if (CurrentKeyboardStates[i].IsKeyUp(key) && _lastKeyboardStates[i].IsKeyDown(key))
                {
                    playerIndex = index;
                    return true;
                }
            ...
            playerIndex = PlayerIndex.One; // Default value if no release was detected.
            return false;
        }
